...
docker network create --driver=bridge --subnet=192.168.105.0/24 --ip-range=192.168.105.0/24 --gateway=192.168.105.254 brsgi
docker network create --driver=bridge --subnet=192.168.106.0/24 --ip-range=192.168.106.0/24 --gateway=192.168.106.254 brs1u
